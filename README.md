...
Build scripts, patches, kernel config, DTS files, tools, and firmware for Linux images targeting the Huawei MateBook E Go 2023 (codename `gaokun3`).

The device is based on Qualcomm Snapdragon 8cx Gen3 (`SC8280XP`).
